...
class My_SocialNetworksWidget extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		$networks['Email']['link']     = $instance['email'];
		...
		$networks['Email']['label']    = $instance['email_label'];
		...
		<?php foreach(array("Twitter", "Facebook", "Email", "Feed", "Linkedin", "Delicious", "Youtube", "Google+") as $network) : ?>
	...
	function form( $instance ) {
		...
		$defaults = array( 'title' => '', 'twitter' => '', 'twitter_label' => '', 'facebook' => '', 'facebook_label' => '', 'email' => '', 'email_label' => '', 'feed' => '', 'feed_label' => '', 'linkedin' => '', 'linkedin_label' => '', 'delicious' => '', 'delicious_label' => '', 'youtube' => '', 'youtube_label' => '', 'google' => '', 'google_label' => '', 'display' => 'icons', 'text' => '');
...
?>
	...
	<fieldset style="border:1px solid #dfdfdf; padding:10px 10px 0; margin-bottom:1em;">
		<legend style="padding:0 5px;"><?php echo 'Email' ?>:</legend>
	<p><label for="<?php echo $this->get_field_id('email'); ?>"><?php echo 'Email URL:' ?></label>
	...
	<p><label for="<?php echo $this->get_field_id('email_label'); ?>"><?php echo 'Email '.theme_locals("label") ?></label>
